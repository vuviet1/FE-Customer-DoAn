...
function ProductModal({ show, handleClose, selectedOrderId }) {
    ...
    const fetchProductItems = async () => {
        ...
        try {
            ...
            console.log("Fetched cart data:", cartData); // Logging the fetched data
            setProductItems(cartData);
    ...
    const handleSearch = (event) => {
        ...
        console.log("Filtered items:", filtered); // Logging the filtered items
            ...
            <Modal.Body>
                ...
                <div className="d-flex justify-content-center">
                    <ReactPaginate
                        ...
                        breakLabel={"..."}
                        pageCount={Math.ceil(Array.isArray(filteredItems) ? filteredItems.length / itemsPerPage : 0)}
